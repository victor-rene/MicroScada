...
class Editor:
  ...
  @classmethod
  def pipe_i(cls, touch):
    cls.mode = 'pipe-i'
    
  @classmethod
  def pipe_l(cls, touch):
    cls.mode = 'pipe-l'
    
  @classmethod
  def pipe_t(cls, touch):
    cls.mode = 'pipe-t'
    
  @classmethod
  def pipe_x(cls, touch):
    cls.mode = 'pipe-x'
  ...
  @classmethod
  def turn_left(cls, touch):
    cls.mode = 'turn-left'
    
  @classmethod
  def turn_right(cls, touch):
    cls.mode = 'turn-right'
